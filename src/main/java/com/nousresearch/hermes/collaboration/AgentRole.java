...
public class AgentRole {
    ...
    public AgentRole(String roleName, String description, Level level) {
    ...
    // Fluent setters
    public AgentRole skills(String... names) { Collections.addAll(skills, names); return this; }
    public AgentRole responsibilities(String... items) { Collections.addAll(responsibilities, items); return this; }
    public AgentRole reportsTo(String id) { this.reportsTo = id; return this; }
    ...
    public AgentRole minTaskScore(double score) { this.minTaskScore = score; return this; }
    public AgentRole maxConsecutiveFailures(int n) { this.maxConsecutiveFailures = n; return this; }
