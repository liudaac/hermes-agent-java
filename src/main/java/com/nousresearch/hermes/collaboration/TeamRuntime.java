...
public class TeamRuntime {
    private static final Logger logger = LoggerFactory.getLogger(TeamRuntime.class);
    ...
    public TeamRuntime(String teamId, String name, String mission, String tenantId, String createdBy) {
