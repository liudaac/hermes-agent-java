...
public class ActiveMemoryService {
    ...
    public ActiveMemoryService(WorkspaceService workspaceService) {
        this(new FileActiveMemoryRepository(Constants.getHermesHome().resolve("business/workspaces")), workspaceService);
    }

    public ActiveMemoryService(Path workspacesRoot, WorkspaceService workspaceService) {
        this(new FileActiveMemoryRepository(workspacesRoot), workspaceService);
    }

    public ActiveMemoryService(FileActiveMemoryRepository repository, WorkspaceService workspaceService) {
