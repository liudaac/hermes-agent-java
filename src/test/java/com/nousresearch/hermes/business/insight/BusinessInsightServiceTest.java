...
class BusinessInsightServiceTest {
    ...
    private Fixture fixture(boolean createWorkspace) {
        ...
        BusinessRunService runService = new BusinessRunService(tempDir.resolve("business/workspaces"), workspaceService);
        ...
        return new Fixture(workspaceService, teamBlueprintService, runService, approvalService,
