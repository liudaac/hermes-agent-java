...
## 3.6 吸收 OpenClaw 的成功经验：从“会调用模型”到“有组织地完成任务”
...
### 3.6.2 Hermes 的 Prompt Stack：提示词不再是一段文本，而是一组资产
...
### 3.6.3 业务团队工作区：把 OpenClaw Workspace 文件产品化
...
### 3.6.8 技能路由和工具纪律：不是工具越多越好，而是按场景最小授权
...
```text
Business Portal：给业务用，聚焦空间、场景、团队、规则、审批、效果、优化；视觉上要时尚、有动效、低门槛
