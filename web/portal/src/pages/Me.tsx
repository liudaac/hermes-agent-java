          ...
          <>
            ...
            <GlassCard className="mb-4">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[oklch(0.78_0.16_70_/_0.18)] text-[oklch(0.88_0.12_70)]">
                  <UserIcon className="h-5 w-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <h2 className="truncate text-[16px] font-semibold text-[var(--color-text-primary)]">
            ...
            <div className="space-y-2.5">
              {NAV_CARDS.map(({ to, icon: Icon, titleKey, hintKey }) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[oklch(0.78_0.16_70_/_0.12)] text-[oklch(0.78_0.12_70)]">
            ...
            <GlassCard className="mt-4">
              <div className="mb-3 flex items-center justify-between">
                ...
                {editingPrefs ? (
                  <button
                    onClick={savePrefs}
                    className="text-[13px] font-medium text-[var(--color-accent)] active:scale-95 transition"
                  >
                    {t("common.confirm")}
                  </button>
                ) : (
                ...
                <div className="space-y-3">
                  <PrefRow label={t("me.preferences")} >
                    <select
                      ...
                      className="rounded-lg bg-white/10 px-3 py-1.5 text-[13px] text-[var(--color-text-primary)]"
                    >
                  ...
                  <label className="flex items-center justify-between">
                    <span className="text-[13px] text-[var(--color-text-muted)]">自动批准安全操作</span>
                    <input
                      type="checkbox"
            ...
            <div className="mt-4 flex gap-2">
              <a
                ...
                className="flex flex-1 items-center gap-2 rounded-2xl bg-white/5 p-3 text-[13px] transition hover:bg-white/10 active:scale-95"
              >
