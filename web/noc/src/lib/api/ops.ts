...
export const opsApi = {
  ...
  // ── Plugin & theme APIs (shared with noc historically) ──
  getPlugins: () => fetchJSON<PluginManifest[]>("/api/dashboard/plugins"),
  getThemes: () => fetchJSON<ThemeListResponse>("/api/dashboard/themes"),
  setTheme: (name: string) =>
    fetchJSON<ThemeSetResponse>("/api/dashboard/theme", {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
