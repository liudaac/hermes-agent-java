/**
 * NOC-specific SSE stream factories.
 *
...
/** Build a bare EventSource for the legacy business-event stream. */
export function createBusinessEventStream(): EventSource {
  return new EventSource("/api/v1/business/events/stream");
}
