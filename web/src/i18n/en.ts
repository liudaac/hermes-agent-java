...
export const en: Translations = {
  ...
  skills: {
    ...
    all: "All",
    noCapabilities: "No skills found. Capabilities are loaded from ~/.hermes/skills/",
    noCapabilitiesMatch: "No skills match your search or filter.",
  ...
  tenants: {
    ...
    noCapabilitiesInstalled: "No tenant-scoped skills installed.",
    noDescription: "No description available.",
    readOnly: "Read-only",
  ...
  orgManage: {
    ...
    teams: { title: "Agent teams", formTitle: "Agent team", empty: "No agent teams yet", saveAgent team: "Save agent team", saveFailed: "Failed to save agent team", deleteFailed: "Failed to delete agent team", deleteConfirm: "Delete agent team {team}?", teamId: "Agent team ID", name: "Name", mission: "Mission", members: "Agent members", lead: "Lead agent", showDetails: "Show details", hideDetails: "Hide details", missingRole: "missing profile" },
  ...
  orgControl: {
    ...
    sections: { teams: "Agent teams", intentRuns: "Intent Runs", recentTraces: "Recent Traces", anomalies: "Anomalies", controlTimeline: "Control Action Timeline", browserControls: "Browser Bridge Controls", browserApprovals: "Browser Approval Queue", browserTimeline: "Browser Timeline", evolution: "Evolution", tenantRows: "Tenant Rows" },
