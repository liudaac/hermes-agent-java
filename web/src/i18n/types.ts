...
export interface Translations {
  ...
  orgControl: {
    ...
    sections: { teams: string; intentRuns: string; recentTraces: string; anomalies: string; controlTimeline: string; browserControls: string; browserApprovals: string; browserTimeline: string; evolution: string; tenantRows: string; };
    empty: { teams: string; intentRuns: string; traces: string; anomalies: string; audit: string; browserStatus: string; browserApprovals: string; browserActions: string; evolution: string; };
