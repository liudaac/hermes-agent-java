...
import type { IndustryDashboardResponse } from "@/lib/api";
          ...
          {!data || data.byCategory.length === 0 ? (
            ...
            <div className="space-y-3">
              {data.byCategory.map((b) => {
                ...
                return (
                  <div key={b.category} className="rounded-md border border-border/60 p-3">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-3 text-xs text-muted-foreground">
                        ...
                        {b.failed > 0 && <span className="font-mono text-rose-500">{b.failed} 失败</span>}
